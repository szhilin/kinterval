...
%!assert (prod (kinterval (1 : 4)) == kinterval (24, 24));

%!assert (prod (kinterval ([])) == kinterval (1, 1));

%!assert (prod (kinterval (magic (3))) == kinterval ([96, 45, 84]));
%!assert (prod (kinterval (magic (3)), 2) == kinterval ([48; 105; 72]));
%!assert (prod (kinterval (magic (3)), 3) == kinterval (magic (3)));

%!assert (prod (prod (reshape (kinterval (1:24), 1, 2, 3, 4))) == kinterval (reshape ([720, 665280, 13366080, 96909120], 1, 1, 1, 4)))
