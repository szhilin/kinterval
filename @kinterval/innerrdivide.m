...
## @defmethod Method {@@kinterval} innerdivide (@var{X}, @var{Y})
##
## Compute inner right division for Kaucher intervals @var{X} and @var{Y}.
##
## @example
## @group
## x = kinterval (2, 3);
...
function result = innerrdivide(x,y)
    ...
    result = x .* kinterval(1 ./ y.inf, 1 ./ y.sup);
endfunction
